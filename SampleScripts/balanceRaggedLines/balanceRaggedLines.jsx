...
/* Balances ragged lines for text frames within a document */
function balanceRaggedLines (document,labels,balance) {

    var allFrames = document.allPageItems;
    var labelledFrames = []

    UTILS.Log('Inside Balanced Ragged Lines')
    ...
    // Balance ragged lines for all paragraphs in the labelled frames
    ...
    for (var i = 0; i < labelledFrames.length; i++) {
        ...
        for (var j = 0; j < paragraphs.length; j++) {
            ...
            if(balance===true){
                para.balanceRaggedLines = true;
            }
            else{
                para.balanceRaggedLines = false;
            }
        }
    }
    document.save();
...
function ProcessParams (parameters) {
    ...
    var balance = parameters.balance

    // Calling the function to balance ragged lines
    balanceRaggedLines(document,labels,balance);
